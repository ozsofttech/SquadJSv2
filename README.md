...
## **About**
SquadJSv2 is a fork of [SquadJS](https://github.com/Team-Silver-Sphere/SquadJS). Started as a way to maintain SquadJS support with the recent changes from Squad V7 backend using EOS.
...
## SquadJS API
SquadJSv2 has temporarily disabled pinging SquadJS API due to unimplemented changes caused by A2S not being supported anymore.

## Versions and Releases
Whilst installing SquadJSv2 you may do the following to obtain slightly different versions:
* Download/clone the [`master` branch](./) - To get the most up to date version of SquadJSv2.

## Credits
SquadJSv2 would not be possible without the support of so many individuals and organisations. Our thanks goes out to:
